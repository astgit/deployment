...
define(function (require) {
    ...
    function ParallaxSection () {
        ...
        function _events () {
            ...
            $(".screen").swipe( {
                ...
                swipeDown:function(event, distance, duration, fingerCount, fingerData) {
                    ...
                    if ( $('.background.active').is('#background-1') ){

                    } else if ( $('.background.active').is('#background-7') ){
                        _paraScrollUp();
        ...
        function _setup () {
            ...
            var screen1sequence = new TimelineMax()
                .add([
                    TweenMax.to('#screen-1 .screen__item', tween_duration, tween_options),
                ]);

            var screen2sequence = new TimelineMax()
                .add([ 
                    TweenMax.to('#screen-2 .screen__item', tween_duration, tween_options),
                ]);

            var screen3sequence = new TimelineMax()
                .add([ 
                    TweenMax.to('#screen-3 .screen__item', tween_duration, tween_options),
                ]);

            var screen4sequence = new TimelineMax()
                .add([ 
                    TweenMax.to('#screen-4 .screen__item', tween_duration, tween_options),
                ]);

            var screen5sequence = new TimelineMax()
                .add([ 
                    TweenMax.to('#screen-5 .screen__item', tween_duration, tween_options),
                ]);

            var screen6sequence = new TimelineMax()
                .add([ 
                    TweenMax.to('#screen-6 .screen__item', tween_duration, tween_options),
                ]);

            scenes[0] = new ScrollMagic.Scene({triggerElement: '#screen-1'})
                .setClassToggle('#screen-1, #anchor-1', 'active')
                // .setPin(".no-touchevents  #screen-1")
                .setTween(screen1sequence)
                .addTo(controller)
                .on("enter", function (e) {
                    // $('#downwards').attr('href', '#screen-2');
                });

            scenes[1] = new ScrollMagic.Scene({triggerElement: '#screen-2'})
                .setClassToggle('#screen-2, #anchor-2', 'active')
                // .setPin(".no-touchevents  #screen-2")
                .setTween(screen2sequence)
                .addTo(controller)
                .on("enter", function (e) {
            ...
            scenes[2] = new ScrollMagic.Scene({triggerElement: '#screen-3'})
                .setClassToggle('#screen-3, #anchor-3', 'active')
                // .setPin(".no-touchevents  #screen-3")
                .setTween(screen3sequence)
                .addTo(controller)
                .on("enter", function (e) {
            ...
            scenes[3] = new ScrollMagic.Scene({triggerElement: '#screen-4'})
                .setClassToggle('#screen-4, #anchor-4', 'active')
                // .setPin(".no-touchevents  #screen-4")
                .setTween(screen4sequence)
                .addTo(controller)
                .on("enter", function (e) {
            ...
            scenes[4] = new ScrollMagic.Scene({triggerElement: '#screen-5'})
                .setClassToggle('#screen-5, #anchor-5', 'active')
                // .setPin(".no-touchevents  #screen-5")
                .setTween(screen5sequence)
                .addTo(controller)
                .on("enter", function (e) {
                    // $('#downwards').attr('href', '#screen-6');
                });

            scenes[5] = new ScrollMagic.Scene({triggerElement: '#screen-6'})
                .setClassToggle('#screen-6, #anchor-6', 'active')
                // .setPin(".no-touchevents  #screen-6")
                .setTween(screen6sequence)
                .addTo(controller)
                .on("enter", function (e) {
            ...
            scenes[6] = new ScrollMagic.Scene({triggerElement: '#screen-7'})
                .on("enter", function (e) {
                    // $('#downwards').attr('href', '#screen-1').addClass('scroll-up');
                })
                .setClassToggle('#screen-7, #anchor-7', 'active')
                .addTo(controller)
                .on("leave", function (e) {
        ...
        function _paraScroll (e) {
            ...
            if ( $('html').hasClass('touchevents') ){
                var nextSlide = $('.background.active').next().attr('id'), // Finds the 'active' slide and fetches the next slide's ID
                    activeSlideIndex = $('.background.active').index()+1, // Fetches index of the 'active' slide
